                ...
                [
                  {
                    ...
                    "content": "Stable diffusion prompt words for the current item. Please comprehensively and thoroughly list all details and visual characteristics in single-word format as much as possible. Do not include any descriptions related to humans, usage scenarios, or other items. The description must exclusively focus on the current item without referencing any other objects. For example, if the current item is a top, only describe the top. Sets (including bikini sets, suits, etc.) must be split into individual pieces, each described separately, clearly indicating whether the current item is a top or pants.",
