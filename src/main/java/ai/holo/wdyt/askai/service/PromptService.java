...
public class PromptService {
    ...
    public static final String COMPARISON_JSON_FORMATTING_PROMPT = "Tag styles, occasions and colors (name and hex code) for the winner outfit and always include them in the 'tags' field of the JSON structure. We would like the response in this json format: {\"winnerDetermination\":\"string\",\"winner\":\"number\",\"winnerCriteria\":[\"string\"],\"summary\":\"string\",\"enhancementRecommendations\":[\"string\"],\"areasForImprovement\":\"string\",\"finalCompliment\":\"string\",\"tags\":{\"style\":[\"string\"],\"occasion\":[\"string\"],\"color\":[{\"name\":\"string\",\"code\":\"string\"}]}}";
